...
const Navbar = () => {
  ...
  return (
    <AppBar position="static" sx={{  backgroundColor: "#1c1515c9",  // Set your desired background color here
      boxShadow: "none", }}>
              ...
              <Button
                ...
                sx={{
                  ...
                  transition: "color 0.1s ease",
                   "&:hover": {
                     color: "yellow",
                     backgroundColor: "rgba(255, 255, 255, 0.1)", // Optional background effect
